...
export const PricingCard = ({
  ...
  return (
    <div className={cardClasses.trim()}>
      ...
      <div className="mb-3">
        <h2 className="text-[40px] font-extralight tracking-[-0.03em] text-white font-roboto">{planName}</h2>
        <p className="text-[14px] text-white/60 mt-1 font-segoe">{description}</p>
      </div>
      <div className="my-6 flex items-baseline gap-2">
        <span className="text-[48px] font-extralight text-white font-roboto">${price}</span>
        <span className="text-[14px] text-white/60 font-segoe">/mo</span>
      </div>
      <div className="w-full mb-5 h-px bg-white/10" />
    ...
    <div className="bg-background text-foreground min-h-screen w-full overflow-x-hidden">
      ...
      <main className="relative w-full min-h-screen flex flex-col items-center justify-center px-4 py-8">
        <div className="w-full max-w-5xl mx-auto text-center mb-14">
          <h1 className="text-[48px] md:text-[64px] font-extralight leading-tight tracking-[-0.03em] bg-clip-text text-transparent bg-gradient-to-r from-slate-900 via-cyan-500 to-blue-600 dark:from-white dark:via-cyan-300 dark:to-blue-400 font-roboto">
            {title}
          </h1>
          <p className="mt-3 text-[16px] md:text-[20px] text-foreground/80 max-w-2xl mx-auto font-segoe">
            {subtitle}
          </p>
        </div>
